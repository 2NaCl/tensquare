package com.fyj.gathering.service;

import com.fyj.gathering.dao.GatheringDao;
import com.fyj.gathering.pojo.Gathering;
...
public class GatheringService {
	 ...
	 * @param gathering
	 */
	@CacheEvict(value = "gathering", key = "#gathering.id")//添加缓存
